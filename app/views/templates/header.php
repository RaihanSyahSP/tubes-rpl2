...
<body class="bg-dark text-white mt-0" data-bs-spy="scroll" data-bs-target="#navScroll">
    ...
    <nav id="navScroll" class="navbar navbar-dark bg-black" tabindex="0">
        <div class="container">
            <a class="navbar-brand fs-4 col-12 col-md-auto text-center" href=<?= BASEURL; ?>>
                ...
                <span class="ms-md-1 fw-bolder me-md-5">Mobazeer</span>
            </a>
